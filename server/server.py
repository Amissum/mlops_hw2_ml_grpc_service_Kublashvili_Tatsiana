...
from mlops_hw2_ml_grpc_service_Kublashvili_Tatsiana.server.inference import ModelRunner
from mlops_hw2_ml_grpc_service_Kublashvili_Tatsiana.server.validation import features_to_dict, ValidationError

MODEL_PATH = os.getenv("MODEL_PATH", "./mlops_hw2_ml_grpc_service_Kublashvili_Tatsiana/models/model.pkl")
